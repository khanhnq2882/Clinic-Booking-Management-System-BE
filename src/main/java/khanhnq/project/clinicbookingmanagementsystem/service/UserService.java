...
public interface UserService {
    ...
    String requestBecomeDoctor(AddRoleDoctorRequest addRoleDoctorRequest);
    String uploadMedicalLicense(MultipartFile multipartFile);
    String uploadMedicalDegree(MultipartFile multipartFile);
